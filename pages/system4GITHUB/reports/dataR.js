            ...
            <Grid item xs={12} py={1}>
              ...
              <Grid item xs={4}>
                    ...
                    <IconButton color="primary" aria-label="upload picture" component="label" sx={{ ml: 5}}>
                        <Image src="/picExcel.jpg" alt="Banner" width={`30px`}  height={'25px'} />
                    </IconButton>
                    <text className={styles.kanit}>|</text>
                    <IconButton color="primary" aria-label="upload picture" component="label">
                        <Image src="/picCSV.jpg" alt="Banner" width={`30px`}  height={'25px'} />
                    </IconButton>
                    <text className={styles.kanit}>|</text>
                    <IconButton color="primary" aria-label="upload picture" component="label">
                        <Image src="/picWord.jpg" alt="Banner" width={`30px`}  height={'25px'} />
                    </IconButton>
                    <text className={styles.kanit}>|</text>
                    <IconButton color="primary" aria-label="upload picture" component="label">
                        <Image src="/picPDF.jpg" alt="Banner" width={`30px`}  height={'25px'} />
                    </IconButton>
              </Grid>
              </Grid>
            </Grid>
